...
```json
{
    ...
    "limitCount": 71, // 人数上限
    "acrossMajorLimitCount": 5, // 跨专业人数上限
    ...
    "departments": [
      {
        "id": 132,
        "nameZh": "心理与认知科学学院",
        "nameEn": "College of Psychology and Cognitive Science",
        "code": "0132",
        "telephone": null
      },
      {
        "id": 135,
        "nameZh": "社会发展学院",
        "nameEn": "School of Social Development",
        "code": "0135",
        "telephone": null
      }
    ], // 开课部门
...
```json
{
  ...
  "majorId": "", // 专业ID
  "campusId": "", // 校区ID
  "openDepartmentId": "", // 开课部门ID
  "courseTypeId": "", // 课程类型ID
  "coursePropertyId": "", // 课程属性ID
  "canSelect": 1, // 是否可选 （1/0）
  "_canSelect": "可选", // 可选/不可选
  "creditGte": "1", // 学分大于等于
  "creditLte": "2", // 学分小于等于
  "hasCount": null, // 仅看有余量true，否则null
  "ids": null,
...
```
### 课程名额查询（批量）
- POST https://byyt.ecnu.edu.cn/course-selection-api/api/v1/student/course-select/std-count
- Body
```json
{
  "lessonIds": [
...
均采用先验证后查询
### 发起选课验证
- POST https://byyt.ecnu.edu.cn/course-selection-api/api/v1/student/course-select/add-predicate
- Body
```json
{
  "studentAssoc": 000000, // 学生ID
  "courseSelectTurnAssoc": 00, // 选课轮次ID
  "requestMiddleDtos": [
    {
      "lessonAssoc": 000000, // 课程ID
      "virtualCost": 0 // 意愿值
    }
  ],
  "coursePackAssoc": null
...
```
### 发起选课请求
- POST https://byyt.ecnu.edu.cn/course-selection-api/api/v1/student/course-select/add-request
- Body
```json
{
  "studentAssoc": 000000, // 学生ID
...
```
### 发起退课验证
- POST https://byyt.ecnu.edu.cn/course-selection-api/api/v1/student/course-select/drop-{predicate/request}
- Body
```json
{
  "studentAssoc": 000000, // 学生ID
...
```
### 发起退课请求
- POST https://byyt.ecnu.edu.cn/course-selection-api/api/v1/student/course-select/drop-request
- Body
```json
{
  "studentAssoc": 000000, // 学生ID
...
```
## 检查token有效性
- GET https://byyt.ecnu.edu.cn/course-selection-api/api/v1/student/course-select/getCurrentDateTime
- Response
```json
{
  "result": 0,
  "message": null,
  "data": "2025-12-19 15:02:41" // 服务器当前时间
}
```
- 若token无效则返回401错误