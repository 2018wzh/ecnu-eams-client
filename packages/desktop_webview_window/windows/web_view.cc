      ...
      Callback<ICoreWebView2NavigationStartingEventHandler>(
          [this](ICoreWebView2 *sender,
            ...
            if (triggerOnUrlRequestedEvent) {
                  ...
                  std::make_unique<flutter::MethodResultFunctions<>>(
                      [uri_string, sender,
                       this](const flutter::EncodableValue *success_value) {
                        ...
                        if (letPass) {
                          this->triggerOnUrlRequestedEvent = false;
              ...
              // Keep native navigation until the next explicit launch.
              // Re-enabling interception here breaks redirects and POST forms.
              triggerOnUrlRequestedEvent = !nativeNavigation;
            }
            return S_OK;
          })
          .Get(),
